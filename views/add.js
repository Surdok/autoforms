    ...
    try {
      ...
      autoform.properties().forEach((property) => {
        ...
        /** Otherwise, if the property type is 'int' and there are no options... */
          ...
          form.number().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
        ...
        /** Otherwise, if the property type is 'date'... */
          ...
          form.date().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
      
        /** Otherwise, if the property type is 'datetime'... */
        else if ( property.type() == `datetime` )
          form.datetime().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
      
        /** Otherwise, if the property type is 'time'... */
        else if ( property.type() == `time` )
          form.time().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
      
        /** Otherwise, if the property type is 'email'... */
        else if ( property.type() == `email` )
          form.email().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
      
        /** Otherwise, if the property type is 'time'... */
        else if ( property.type() == `tel` )
          form.tel().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).pattern(property.pattern()).required(property.required()).disabled(property.disabled());
        ...
        /** Otherwise, if the property type is 'textarea'... */
          ...
          form.textarea().addClass(property.inputCenter() ? `text-center` : `text-left`).colsBefore(property.inputColumnsBefore()).cols(property.inputColumns()).colsAfter(property.inputColumnsAfter()).name(property.name()).label(property.inputLabel()).required(property.required()).disabled(property.disabled());
